 ...
 */
final class Version20210511213337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, current_round_id INT NOT NULL, status VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_232B318C3B78268A (current_round_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE round (id INT AUTO_INCREMENT NOT NULL, current_word_id INT DEFAULT NULL, game_id INT NOT NULL, topic VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C5EEEA34495AC608 (current_word_id), INDEX IDX_C5EEEA34E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE round_stats (id INT AUTO_INCREMENT NOT NULL, round_id INT NOT NULL, word VARCHAR(255) NOT NULL, count SMALLINT NOT NULL, INDEX IDX_81347353A6005CA0 (round_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_score (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, game_id INT NOT NULL, score SMALLINT NOT NULL, INDEX IDX_D05BCC09A76ED395 (user_id), INDEX IDX_D05BCC09E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE word (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, round_id INT NOT NULL, word VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_C3F17511A76ED395 (user_id), UNIQUE INDEX UNIQ_C3F17511A6005CA0 (round_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
